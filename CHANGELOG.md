...
- **Network Isolation**: Resolved firewall (`iptables`) conflicts in Docker networking for more resilient container restarts.
- **Dependency Management**: Optimized `poetry.lock` for faster builds and verified compatibility with Python 3.12 syntax.
...
### Added
- **Multi-Registry CI/CD**: Upgraded the `.github/workflows/cd.yml` pipeline to automatically build and push Docker images to both Docker Hub and GitHub Container Registry (GHCR) upon new semantic version tags.
- **Layer Caching Optimization**: Integrated `docker/build-push-action` with GHA caching to drastically reduce build times for ML dependencies across deployment cycles.
...
[1.0.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v1.0.0
[0.9.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.9.0
[0.8.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.8.0
[0.7.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.7.0
[0.6.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.6.0
[0.5.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.5.0
[0.4.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.4.0
[0.3.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.3.0
[0.2.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.2.0
[0.1.1]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.1.1
[0.1.0]: https://github.com/MarioCarvalhoBr/retail-ai-mlops-fastapi-template/releases/tag/v0.1.0
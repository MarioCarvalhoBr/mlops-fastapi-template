...
_product_catalog = [
    {"id": "P001", "name": "Wireless Noise-Canceling Headphones", "category": "Electronics", "description": "High-quality over-ear headphones with active noise cancellation and 30-hour battery life. Perfect for travel."},
    {"id": "P002", "name": "Ergonomic Office Chair", "category": "Furniture", "description": "Comfortable mesh chair with lumbar support and adjustable armrests to prevent back pain during long working hours."},
    {"id": "P003", "name": "Mechanical Gaming Keyboard", "category": "Gaming", "description": "RGB backlit mechanical keyboard with tactile blue switches and an aerospace-grade aluminum frame."},
    {"id": "P004", "name": "Smartphone Gimbal Stabilizer", "category": "Photography", "description": "3-axis handheld gimbal for smartphones, perfect for smooth video recording and vlogging on the go."},
    {"id": "P005", "name": "Stainless Steel Water Bottle", "category": "Sports & Outdoors", "description": "Insulated double-wall water bottle that keeps drinks cold for 24 hours or hot for 12 hours. Leak-proof."},
    {"id": "P006", "name": "Running Shoes", "category": "Footwear", "description": "Lightweight breathable mesh running shoes with advanced shock absorption and a durable rubber outsole."},
]
